...
function _MediaObject(e){var t=this;EventEmitter.call(this),Object.defineProperty(this,"id",{value:e});var i={};this.on("removeListener",function(e){if("release"!=e&&"_rpc"!=e&&"newListener"!=e){var r=EventEmitter.listenerCount(t,e);if(!r){var n=i[e];this.emit("_rpc","unsubscribe",{subscription:n},function(r){return r?t.emit("error",r):void delete i[e]})}}}),this.on("newListener",function(e){if("release"!=e&&"_rpc"!=e&&"_create"!=e){var r=EventEmitter.listenerCount(t,e);r||this.emit("_rpc","subscribe",{type:e},function(r,n){return r?t.emit("error",r):void(i[e]=n)})}})}var EventEmitter=_dereq_("events").EventEmitter,inherits=_dereq_("inherits"),Promise=_dereq_("es6-promise").Promise,utils=_dereq_("./utils"),noop=utils.noop,promiseCallback=utils.promiseCallback;inherits(_MediaObject,EventEmitter),_MediaObject.prototype.invoke=function(e,t,i){var r=this;if(t instanceof Function){if(i)throw new SyntaxError("Nothing can be defined after the callback");i=t,t=void 0}var n=new Promise(function(i,n){var o={operation:e};t&&(o.operationParams=t),r.emit("_rpc","invoke",o,function(e,t){return e?n(e):void i(t.value)})});return promiseCallback(n,i),n},_MediaObject.prototype.release=function(e){var t=this,i=new Promise(function(e,i){t.emit("_rpc","release",{},function(r){return r?i(r):(t.emit("release"),t.removeAllListeners(),void e())})});return promiseCallback(i,e),i},module.exports=_MediaObject;
//# sourceMappingURL=kws-media-api.map
