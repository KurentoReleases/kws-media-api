...
function KwsMedia(e,n,r,t){function i(e){var n=e.method,r=e.params.value,t=r.object,i=l[t];if(!i)return console.warn("Unknown object id '"+t+"'",e);switch(n){case"onEvent":i.emit(r.type,r.data);break;default:console.warn("Unknown message type '"+n+"'")}}function o(e){for(var n in e){var r=e[n];r instanceof MediaObject&&(e[n]=r.id)}return e}function c(e,n,r){var t=new e(n,r);return t.on("release",function(){delete l[n]}),t.on("_rpc",function(e,r,t){r.object=n,r.operationParams=o(r.operationParams),v.encode(e,r,function(e,n){if(e)return t(e);var i=r.operation;if("getConnectedSinks"==i||"getMediaSinks"==i||"getMediaSrcs"==i){var o=n.sessionId;return d.getMediaobjectById(n.value,function(e,n){var n={sessionId:o,value:n};t(e,n)})}t(null,n)})}),(t instanceof Hub||t instanceof MediaPipeline)&&t.on("_create",d.create.bind(d)),l[n]=t,t}function a(e){return core[e]||endpoints[e]||filters[e]||hubs[e]||abstracts[e]||MediaObject}function s(e,n){var r=e.type,t=a(r);if(t.create){e=t.create(e.params);var i=t.prototype;inherits(t,a(e.type)),extend(t.prototype,i)}e.constructorParams=checkParams(e.params,t.constructorParams,r),delete e.params,e.constructorParams=o(e.constructorParams),v.encode("create",e,function(e,r){if(e)return n(e);var i=r.value,o=l[i];return o?n(null,o):void n(null,c(t,i))})}function u(e,n){var r=l[e];return r?n(null,r):void v.encode("describe",{object:e},function(r,t){if(r)return n(r);var i=t.type,o=a(i);if(o.create){item=o.create(item.params);var s=o.prototype;inherits(o,a(item.type)),extend(o.prototype,s)}return n(null,c(o,e))})}if(!(this instanceof KwsMedia))return new KwsMedia(e,n,r,t);var d=this;EventEmitter.call(this),n instanceof Function&&(t=r,r=n,n=void 0),n=n||{};var p,l={};if("string"==typeof e){var f=n.access_token;void 0!=f&&(e=url.parse(e,!0),e.query.access_token=f,e=url.format(e),delete n.access_token),p=new WebSocket(e)}else p=e;var v=new RpcBuilder(JsonRPC,p,function(e){return e instanceof RpcBuilder.RpcNotification?void 0!=e.duplicated?console.warning("Unexpected request:",e):i(e):void console.error("Invalid request instance",e)});p.addEventListener("close",function(e){d.emit("disconnect",e)}),this.then=function(e,n){return new Promise(function(r,t){function i(){var n;if(e)try{n=e(d)}catch(i){return t(i)}r(n)}function o(){var e;if(n)try{e=n(new Error("Connection error"))}catch(r){return t(r)}t(e)}p.readyState==p.OPEN?i():p.addEventListener("open",i),p.readyState>p.OPEN?o():p.addEventListener("error",o)})},this.catch=function(e){return this.then(null,e)},this.then(r,t),this.close=p.close.bind(p),this.getMediaobjectById=function(e,n){var r=new Promise(function(n,r){function t(e,t){return e?r(e):void n(t)}e instanceof Array?async.map(e,u,t):u(e,t)});return n&&r.then(function(e){n(null,e)},n),r},this.create=function(e,n,r){if(n instanceof Function){if(r)throw new SyntaxError("Nothing can be defined after the callback");r=n,n=void 0}var t=new Promise(function(r,t){function i(e,n){return e?t(e):void r(n)}e instanceof Array?async.map(e,s,i):s({params:n||{},type:e},i)});return r&&t.then(function(e){r(null,e)},r),t}}var EventEmitter=require("events").EventEmitter,extend=require("extend"),inherits=require("inherits"),url=require("url"),Promise=require("es6-promise").Promise,async=require("async"),WebSocket=require("ws"),RpcBuilder=require("kws-rpc-builder"),JsonRPC=RpcBuilder.packers.JsonRPC,checkType=require("./checkType"),checkParams=checkType.checkParams,noop=require("./utils").noop,core=require("./core"),endpoints=require("./endpoints"),filters=require("./filters"),hubs=require("./hubs"),Hub=require("./core/Hub"),MediaObject=require("./core/MediaObject"),HubPort=core.HubPort,MediaPipeline=core.MediaPipeline,abstracts={Filter:require("./core/Filter"),Hub:Hub,MediaElement:require("./core/MediaElement"),MediaPad:require("./core/MediaPad"),MediaSink:require("./core/MediaSink"),MediaSource:require("./core/MediaSource"),HttpEndpoint:require("./endpoints/HttpEndpoint"),SdpEndpoint:require("./endpoints/SdpEndpoint"),SessionEndpoint:require("./endpoints/SessionEndpoint"),UriEndpoint:require("./endpoints/UriEndpoint")};inherits(KwsMedia,EventEmitter),KwsMedia.prototype.connect=function(e,n){if(e=Array.prototype.slice.call(arguments,0),n="function"==typeof e[e.length-1]?e.pop():noop,e.length<2)throw new SyntaxError("Need at least two media elements to connect");e.forEach(function(e){checkType("MediaElement","media",e)});var r=new Promise(function(n,r){function t(e,t){return e?r(e):void n(t)}var i=e[0];async.each(e.slice(1),function(e,n){i.connect(e,n),i=e},t)});return n&&r.then(function(e){n(null,e)},n),r},module.exports=KwsMedia;
...
function _MediaObject(e){var t=this;EventEmitter.call(this),Object.defineProperty(this,"id",{value:e});var i={};this.on("removeListener",function(e){if("release"!=e&&"_rpc"!=e&&"newListener"!=e){var r=EventEmitter.listenerCount(t,e);if(!r){var n=i[e];this.emit("_rpc","unsubscribe",{subscription:n},function(r){return r?t.emit("error",r):void delete i[e]})}}}),this.on("newListener",function(e){if("release"!=e&&"_rpc"!=e&&"_create"!=e){var r=EventEmitter.listenerCount(t,e);r||this.emit("_rpc","subscribe",{type:e},function(r,n){return r?t.emit("error",r):void(i[e]=n)})}})}var EventEmitter=require("events").EventEmitter,inherits=require("inherits"),Promise=require("es6-promise").Promise,noop=require("./utils").noop;inherits(_MediaObject,EventEmitter),_MediaObject.prototype.invoke=function(e,t,i){var r=this;if(t instanceof Function){if(i)throw new SyntaxError("Nothing can be defined after the callback");i=t,t=void 0}var n=new Promise(function(i,n){var o={operation:e};t&&(o.operationParams=t),r.emit("_rpc","invoke",o,function(e,t){return e?n(e):void i(t.value)})});return i&&n.then(function(e){i(null,e)},i),n},_MediaObject.prototype.release=function(e){var t=this,i=new Promise(function(e,i){t.emit("_rpc","release",{},function(r){return r?i(r):(t.emit("release"),t.removeAllListeners(),void e())})});return e&&i.then(function(){e()},e),i},module.exports=_MediaObject;
//# sourceMappingURL=kws-media-api.map
...
function Hub(e){MediaObject.call(this,e)}var inherits=require("inherits"),MediaObject=require("./MediaObject");inherits(Hub,MediaObject),Hub.prototype.createHubPort=function(e){var t=this,n=new Promise(function(e,n){t.emit("_create","HubPort",{hub:t},function(t,r){return t?n(t):void e(r)})});return e&&n.then(function(t){e(null,t)},function(t){e(t)}),n},Hub.constructorParams={},Hub.events=[],Hub.events.concat(MediaObject.events),module.exports=Hub,Hub.check=function(e,t){if(!(t instanceof Hub))throw SyntaxError(e+" param should be a Hub, not "+typeof t)};
//# sourceMappingURL=kws-media-api.map
...
function MediaPipeline(e){MediaObject.call(this,e)}var inherits=require("inherits"),Promise=require("es6-promise").Promise,MediaObject=require("./MediaObject");inherits(MediaPipeline,MediaObject),MediaPipeline.prototype.create=function(e,i,n){var t=this;if(i instanceof Function){if(n)throw new SyntaxError("Nothing can be defined after the callback");n=i,i=void 0}i=i||{};var r=new Promise(function(n,r){i.mediaPipeline=t,t.emit("_create",e,i,function(e,i){return e?r(e):void n(i)})});return n&&r.then(function(e){n(null,e)},n),r},MediaPipeline.constructorParams={},MediaPipeline.events=[],MediaPipeline.events.concat(MediaObject.events),module.exports=MediaPipeline,MediaPipeline.check=function(e,i){if(!(i instanceof MediaPipeline))throw SyntaxError(e+" param should be a MediaPipeline, not "+typeof i)};
//# sourceMappingURL=kws-media-api.map
...
function noop(o){o&&console.error(o)}exports.noop=noop;
//# sourceMappingURL=kws-media-api.map
